...
//       <div className="container mx-auto px-6 py-20 md:py-28 flex items-center justify-center min-h-[80vh]">
//         <div className="text-center space-y-8 max-w-4xl">
//           <h1 className="text-shadows text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight">
//             Unlock the Power of Your GitHub Repository with AI!
//           </h1>
//           <p className="text-xl md:text-2xl lg:text-3xl text-primary-foreground/80 max-w-3xl mx-auto">
//             AI-summarized commits and intelligent Q&A for your GitHub projects.
//           </p>
//           <div className="flex flex-col sm:flex-row gap-4 mt-12 justify-center">
//             <button
//               onClick={handleTryItNow}
//               className="inline-flex items-center justify-center rounded-lg bg-accent px-8 py-4 text-lg font-semibold text-accent-foreground transition-all duration-300 hover:bg-accent/90 shadow-2xl"
//             >
